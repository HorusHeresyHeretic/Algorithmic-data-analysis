...
Документы с датами для DS всегда имеют большую ценность, остальное можно смело отдавать в отдел `ананлитики`(тем людям, которые пользуются sql, excel и считают себя аналитиками данных) они быстрее и лучше дадут результат там, где он есть. Всё остальное на нас.

##  Осторожно! [Cаундтрек](https://youtu.be/kcS-xmd4MMQ) для чтения, часть 0.
