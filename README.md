...
В большинстве случаев мы не всегда заглядываем туда, куда нам не хочется и сами решаем что смотреть. В конце концов, мы всегда можем сказать `мусор на входе - мусор на выходе`. Но такая потребность (смотреть в другую сторону) есть.
...
В этом случае алгоритм ананлиза данных может условно закосплеить механизм оценки данных или принятия решения на основе анализа данных таким человеком, с поправкой на большие вычислительные мощности. Бизнес уже готов к этому, я работал в тандеме с MBI последней волны (второй половины 10ых годов) и он отлично дополнял своей головой анализ процессов по временным рядам и радостно рисовал что ещё ему такого дать. 
