...
Если вы работаете в тандеме с людьми, которые мыслят и не являются программистами и которые владеют компетенциями по предметной области - пишите алгоритмы и носите людям распечатки вывода, возможно вас попросят написать ещё один :)
