...
5. При таком подходев блоках счисления можно писать if else (люди которые не пишут их видимо всегда правы)
