...
8. Так степень свободы выше. Возможность управлять процессом вычислений в отношении одного объекта, а потом собирать результат в витрину позволяет управлять логикой алгоритма `вглубине`. Большинство из вас просто рандомно перебирает параметры на кроссвалидации, а зачем? когда машинасама может это сделать?
