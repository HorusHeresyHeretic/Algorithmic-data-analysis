...
Документы с датами для DS всегда имеют большую ценность, остальное можно смело отдавать в отдел `ананлитики`(тем людям, которые пользуются sql, excel) они быстрее и лучше дадут результат там, где он есть. Всё остальное на нас.
