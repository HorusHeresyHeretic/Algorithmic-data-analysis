...
На меньшую - условно доступную и большую, нам не интересную, не интересну ввиду того, что на первых тестах были плохие цифры, а первый полёт фантазии DS ник чему не привёл.
