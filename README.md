...
Наверху я дёрнул алгоритм вокруг Холта-Винтерса на 1К строк который также написан через генератор (возвращает total и roll) и обернут в фукнцию, внизу сложил вывод в новый датафрейм. 
