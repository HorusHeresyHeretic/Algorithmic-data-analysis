...
В этом случае алгоритм ананлиза данных может условно закосплеить механизм оценки данных или принятия решения на основе анализа данных таким человеком, с поправкой на большие вычислительные мощности. 
