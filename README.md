...
В одном из первых уроков MLopen нам всем показали plotly из богоподобного фреймворка DASH, на котором написаны почти все приложения по "аналитике" на этой планете. Козалось бы хороший повод перестать рисовать графики в Matplotlib и выкладывать их в сеть, но доступность готовых решений на базе этой библиотеки убила интерес общественности к тому, что бы самостоятельно программировать графики. Зря. аа
