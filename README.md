...
Алгоритмы хороши тем, что регулярно считают побочную информацию которая на ваш взгляд не имеет ценности. Распечатайте их и принесите людям. Возможно именно над этим последнее время ломал голову профессор или генеральный директор вашей компании.
...
В результате получились решение из 5 уровней:

- первичный ананлиз данных.
- алгоритм.
- суждение компететнтного человека.
- новый алгоритм.
