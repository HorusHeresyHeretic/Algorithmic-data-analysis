...
Из плюсов именно 1Ска хранит неисчерпаемый источник raw data и подчинятьеся учётной политике. Из минусов даже если учётная политика глобальна, как правило каждое предприятие обычно ведёт учёт в 1C по разному, до того как не встретит DS. 
