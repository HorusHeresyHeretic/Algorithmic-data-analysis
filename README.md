...
а потом посмотреть что получилось в принтах дёрнув все го лишь одну функцию
...
если посмотрев мой код напишите своё, не пугайтесь когда после запуска функции снизу вылезет простыня.
