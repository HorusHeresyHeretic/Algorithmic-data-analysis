...
DS генерят идеи, основанные на эмпирических суждениях  просмотра цифр, ранее никому не ведомых и математических правилах (в случае, если знают что квантилей всего 3) и пишут модели. `Аналитики` рисуют графики и выводят KPI. В большинстве случаев используются полигонные условия в рамках правила `мусор на входе - мусор на выходе`. итого все raw data поделены на две неравные части: годноту и мусор. А все результаты носят в лучшем случае 2х (реже 3х) уровневый характер: человек посмотрел, машина посчитала, человек посмотрел на результат и принял решение.  
