...
Обычно DS просто генерят идеи, основанные на эмпирических суждениях просмотра цифр, ранее никому не ведомых и математических правилах (в случае, если знают что квантилей всего 3) или пишут модели.

В большинстве случаев мы не заглядываем туда, куда нам не хочется и сами решаем что смотреть. В конце концов, мы всегда можем сказать `мусор на входе - мусор на выходе`. Но такая потребность (смотреть в другую сторону) есть.

Большинство данных на этой планете - мусор, мусор, который накапливался задолго до того как пришли DS со своими правилами оценки данных. И есть много компетентных людей, которые знают что стоит за этим мусором - учёные и управленцы. Люди которые мыслят в рамках незаконченных теорий или суждений с погрешностью, о размерах которой они не знают (я имею ввиду принятие решений в условиях многих неизвестных). Этим людям нужно решить задачу, отталкиваясь уже от известного,  что бы начать решать следующую.

В этом случае алгоритм ананлиза данных может условно закосплеит механизм оценки данных или принятия решения на основе анализа данных таким человеком. Экономить трудочасы руководителя это тоже автоматизация.
...
А все результаты носят в лучшем случае 2х (реже 3х) уровневый характер: человек посмотрел, машина посчитала, человек посмотрел на результат и принял решение. Итого все raw data поделены на две неравные части: годноту и мусор, равно как и результаты суждения DS `посчитал-понравилось`. Так что в итоге мы заранее разделяем возможный результат на две неравные части.

На меньшую часть условно доступную и большую, нам не интересную, не интересную ввиду того, что на первых тестах были плохие цифры, а первый полёт фантазии DS ни к чему не привёл. Я не отрицаю правило мусор на входе - мусор на выходе, я бы тоже хотел работать в nasa. 

Но большинство данных на нашей планете это мусор. Мусор, потому что он появился задолго до DS и накапливался без правил удобных для DS. При этом число `DS` растёт как на дрожжах, а чистых данных особо не прибавляется :)

Рано или поздно мы посчитаем всё, что в теории можно было посчитать и останется такая малость как всё остальное, что мы считать не хотели - вот эти вот терриконы пентабайт-гигабайт всего и вся и про всё. И в первую очередь и в науке и в бизнесе. 

Наука будет радо тому, что кто-то придёт и по второму кругу прогонит все модели ещё раз во всех местах с более глубокой настройкой, чем раньше. Ну а бизнес уже сейчас готов, выпускники MBI последней волны (второй половины 10ых годов в РФ) в состоянии вдумчиво посмотреть на распечатки и увидеть годноту. 

Если вы работаете в одиночку или в составе DS подразделения - вам это не надо, но если вы работаете в танеме с человеком, который хорошо знает предметную область стоящую за цифрами - пишите алгоритмы. 
