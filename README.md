...
Для любителей кегли, могу показать значения среднеквадратичной ошибки на мусоре с кооф.вариации выше 50%, это дебаг на принтах 16 моделей, которые создаются в рамках алгоритма на один объект с двумя разными типами предсказания и вариативностью суждений.
...
3. Из России я уезжать не собираюсь, пожалуйста прекратите мне с этим надоедать. Я не военнообязанный и мой работодателей может быть уверен в том, что меня не загребут под призыв резервистов, но легко найду дорогу сам.
