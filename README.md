...
Если вы работаете в одиночку или в составе DS подразделения - вам это не надо, но если вы работаете в танеме с человеком, который хорошо знает предметную область стоящую за цифрами - пишите алгоритмы. Алгоритмы хороши тем, что регулярно считают побочную информацию которая на ваш взгляд не имеет ценности. распечатайте их и принесите людям.
