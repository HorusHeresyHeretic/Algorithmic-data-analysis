...
Код и вывод я буду давать слайдами, за исключением случаев, когда не жалко.
...
# Не надо так, зачем? и почему не по pep8.
## Потому что так есть место для мульивывода и try except.
...
2. Нейминг не ваше дело, я ведущий специалист, как хочу так и обзываю ссылки. А если серьёзно то такие вещи пишуться по потоку, при таком подходе действительно можно воткнуть наушники и засесть на пару недель в блок счисления сгловой, поскольку во-первых не нужно перескакивать с вычислительной части на __init__,а во вторых всегда можно дернуть кусок алгоритма, обрезать его и погонять блок счисления безотносительно от общей массы. Для этого нужно просто сохранить вывод предыдущий части и отправить в интересующий вас блок. 
3. 
