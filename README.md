...
Я в гробу видал доцентов и профессоров всего и вся, которые сейчас местами сидят начальниками в DS подразделениях и из моего кода понимают только строку коммита, а ещё при этом пытаются задавать вопросы по теории, своего сына школьника гоняй по теории.
