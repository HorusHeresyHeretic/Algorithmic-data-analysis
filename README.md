...
В этом случае алгоритм ананлиза данных может условно закосплеить механизм оценки данных или принятия решения на основе анализа данных таким человеком. Бизнес уже готов к этому, я работал в тандеме с MBI последней волны (второй половины 10ых годов) и он отлично дополнял своей головой анализ процессов по временным рядам и радостно рисовал что ещё ему такого дать. 
