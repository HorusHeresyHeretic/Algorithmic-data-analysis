...
Алгоритмы хороши тем, что регулярно считают побочную информацию которая на ваш взгляд не имеет ценности в попытках получить циферку. Распечатайте их и принесите людям. Возможно именно над этим последнее время ломал голову профессор или генеральный директор вашей компании.
